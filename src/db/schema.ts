...
export const seasons = pgTable(
  ...
  (table) => [
    uniqueIndex("seasons_competition_code_year_key").on(
...
export const leagueMembers = pgTable(
  ...
  (table) => [
    uniqueIndex("league_members_league_id_user_id_key").on(
      table.leagueId,
      table.userId,
    ),
  ],
...
export const predictions = pgTable(
  ...
  (table) => [
    uniqueIndex("predictions_user_id_match_id_key").on(
      table.userId,
      table.matchId,
    ),
...
export const predictionScores = pgTable(
  ...
  (table) => [
    uniqueIndex("prediction_scores_league_id_prediction_id_key").on(
      table.leagueId,
      table.predictionId,
    ),
  ],
