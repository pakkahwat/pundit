...
export default async function LivePage() {
  ...
  return (
    <PageShell width="lg">
      <AutoRefresh />
      {/* ข้อความไม่พูดเกินสิ่งที่แผนข้อมูลให้จริง — บัญชี SportMonks ปัจจุบันเป็นแผนฟรีซึ่งไม่มี
        พรีเมียร์ลีก สกอร์จึงมาจากรอบ sync ปกติ (หน่วงราวครึ่งชั่วโมง) ถ้าวันไหนอัปเกรดแผน
        สกอร์สด นาทีจริง และเหตุการณ์จะติดขึ้นมาเองทั้งหมด โดยไม่ต้องแก้โค้ดหรือข้อความนี้
        เพราะการ์ดกับ dialog เช็คจากการมีข้อมูลจริง (m.live) ไม่ใช่จากคำโฆษณาบนหัวหน้า */}
      <PageHeader
        title="ผลบอลสด"
        subtitle="พรีเมียร์ลีก · หน้ารีเฟรชเองทุก 30 วินาที ผลนัดที่จบขึ้นภายในราวครึ่งชั่วโมง"
        actions={
